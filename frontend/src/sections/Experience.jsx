  ...
  const experiences = [
    {
      ...
      color: 'cyan',
      bullets: [
        'Designed and developed CareerLens, an AI-powered placement predictor & job intelligence SaaS with real-time what-if simulation dials and PDF resume gap analyzers.',
