    ...
    switch (lower) {
      ...
      case 'projects':
        reply = [
          ...
          { text: '  1. CareerLens- Job Market Intelligence & Placement Analytics (React/Flask/ML)', type: 'text' },
          { text: '  2. MediSmart - AI-Assisted Generic Medicine Swap (React/Tesseract.js OCR)', type: 'text' },
          { text: '  3. PowerMRO - Equipment Health Telemetry (Next.js/TypeScript/Recharts)', type: 'text' },
          { text: '  4. GameIQ   - Player Retention ML Pipeline (Python/Flask/RandomForest)', type: 'text' },
          { text: '  5. Weather  - Asynchronous Location Tracker (Vanilla JS/APIs)', type: 'text' }
        ];
        break;
      case 'kaggle':
        reply = [
